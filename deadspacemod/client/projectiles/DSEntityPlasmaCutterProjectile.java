...
public class DSEntityPlasmaCutterProjectile extends EntityThrowable
{
    public DSEntityPlasmaCutterProjectile(World par1World)
    {
        super(par1World);
    }

    public DSEntityPlasmaCutterProjectile(World par1World, EntityLivingBase par2EntityLivingBase, int offset)
    {
    ...
    public DSEntityPlasmaCutterProjectile(World par1World, double par2, double par4, double par6)
    {
