...
public class DSEntityDevilHornsProjectile extends EntityThrowable
{
    public DSEntityDevilHornsProjectile(World par1World)
    {
        super(par1World);
    }

    public DSEntityDevilHornsProjectile(World par1World, EntityLivingBase par2EntityLivingBase)
    {
        super(par1World, par2EntityLivingBase);
    }

    public DSEntityDevilHornsProjectile(World par1World, double par2, double par4, double par6)
    {
