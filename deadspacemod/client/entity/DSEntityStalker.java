...
public class DSEntityStalker extends EntityMob
{
	//Modifiers	
	public DSEntityStalker(World par1World)
	{
		super(par1World);
		this.setSize(0.5F, 0.5F);
		{
			...
			this.tasks.addTask(5, new EntityAIMoveThroughVillage(this, 4.0D, false));
	...
	//Creature Type	
	public Emun CreatureAttribute getCreatureAttribute()
	{
