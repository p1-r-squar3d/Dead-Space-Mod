...
public class DSEntityEnhancedSlasher extends EntityMob
{
	//Modifiers	
	public DSEntityEnhancedSlasher(World par1World) 
	{
		super(par1World);
		{
			//Tasks
	...
	{
		return "deadspacemod:enslasher_say";
	}
	
	//Hurt Sound on Hit
	protected String getHurtSound()
	{
		return "deadspacemod:enslasher_hurt";
	}
	
	//Death Sound on Death
	protected String getDeathSound()
	{
		return "deadspacemod:enslasher_death";
	}
	
	//Step Sound
	protected void playStepSound(int par1, int par2, int par3, int par4)
	{
		this.worldObj.playSoundAtEntity(this, "deadspacemod:waster_step", 0.15F, 1.0F);
	}
