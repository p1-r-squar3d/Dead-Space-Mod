...
public class DSEntityExploder extends EntityMob
{
	//Modifiers	
	public DSEntityExploder(World par1World) 
	{
		super(par1World);
		{
			//Tasks
	...
	protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setAttribute(0.25D); //Speed
	...
	{
		return "deadspacemod:exploder_say";
	}
	
	//Hurt Sound on Hit
	protected String getHurtSound()
	{
		return "deadspacemod:exploder_hurt";
	}
	
	//Death Sound on Death
	protected String getDeathSound()
	{
		return "deadspacemod:exploder_death";
	}
	
	//Step Sound
	protected void playStepSound(int par1, int par2, int par3, int par4)
	{
		this.worldObj.playSoundAtEntity(this, "deadspacemod:exploder_step", 0.15F, 1.0F);
	}
}