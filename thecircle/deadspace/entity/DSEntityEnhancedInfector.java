...
public class DSEntityEnhancedInfector extends EntityMob
{
	//Modifiers	
	public DSEntityEnhancedInfector(World par1World)
	{
		super(par1World);
		this.setSize(1.6F, 0.7F);
		{
			//Tasks
	...
	{
		return "deadspacemod:infector_say";
	}
	
	//Hurt Sound on Hit
	protected String getHurtSound()
	{
		return "deadspacemod:infector_hurt";
	}
	
	//Death Sound on Death
	protected String getDeathSound()
	{
		return "deadspacemod:infector_death";
	}
