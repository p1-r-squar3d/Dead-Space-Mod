...
public class DSEntitySCAFlightWaster extends EntityMob
{
	//Modifiers	
	public DSEntitySCAFlightWaster(World par1World)
	{
		super(par1World);
		{
			//Tasks
	...
	{
		return "deadspacemod:waster_say";
	}
	
	//Hurt Sound on Hit
	protected String getHurtSound()
	{
		return "deadspacemod:waster_hurt";
	}
	
	//Death Sound on Death
	protected String getDeathSound()
	{
		return "deadspacemod:waster_death";
	}
