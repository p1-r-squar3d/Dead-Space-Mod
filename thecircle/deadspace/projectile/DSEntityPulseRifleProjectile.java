...
public class DSEntityPulseRifleProjectile extends EntityThrowable
{
    public DSEntityPulseRifleProjectile(World par1World)
    {
        super(par1World);
    }

    public DSEntityPulseRifleProjectile(World par1World, EntityLivingBase par2EntityLivingBase)
    {
        super(par1World, par2EntityLivingBase);
    }

    public DSEntityPulseRifleProjectile(World par1World, double par2, double par4, double par6)
    {
