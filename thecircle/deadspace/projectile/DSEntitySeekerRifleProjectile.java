...
public class DSEntitySeekerRifleProjectile extends EntityThrowable
{
    public DSEntitySeekerRifleProjectile(World par1World)
    {
        super(par1World);
    }

    public DSEntitySeekerRifleProjectile(World par1World, EntityLivingBase par2EntityLivingBase)
    {
        super(par1World, par2EntityLivingBase);
    }

    public DSEntitySeekerRifleProjectile(World par1World, double par2, double par4, double par6)
    {
